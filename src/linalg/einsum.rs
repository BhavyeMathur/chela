...
use crate::linalg::sum_of_products::get_sum_of_products_function;
 ...
 */
unsafe fn einsum_2operands_3labels_3outputdims<T: NumericDataType>(op1: *const T,
                                                                   op2: *const T,
                                                                   mut dst: *mut T,
                                                                   strides1: &[usize; 3],
                                                                   strides2: &[usize; 3],
...
unsafe fn einsum_2operands_3labels_2outputdims<T: NumericDataType>(op1: *const T,
                                                                   op2: *const T,
                                                                   mut dst: *mut T,
                                                                   strides1: &[usize; 3],
                                                                   strides2: &[usize; 3],
...
unsafe fn einsum_2operands_3labels_1outputdims<T: NumericDataType>(op1: *const T,
                                                                   op2: *const T,
                                                                   mut dst: *mut T,
                                                                   strides1: &[usize; 3],
                                                                   strides2: &[usize; 3],
...
unsafe fn einsum_2operands_3labels_0outputdims<T: NumericDataType>(op1: *const T,
    ...
    for i in 0..iter_shape[0] {
        for j in 0..iter_shape[1] {
            ...
            sum += sum_of_products([ptr1, ptr2], inner_loop_strides, iter_shape[2]);
        }
    }
